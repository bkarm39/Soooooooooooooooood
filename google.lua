...
send(msg.chat_id_, msg.id_, "بس يا اهطل دا عيوني🎸ܰ\n")
return false 
end
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(1520530041) then
send(msg.chat_id_, msg.id_, "بس يا اهطل دا عيوني🎸ܰ\n")
return false 
end
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(1463960994) then
send(msg.chat_id_, msg.id_, "܁♪•┆لايمكنك كتم مطور السورس 🎸ܰ\n")
return false 
end
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(1520530041) then
...
send(msg.chat_id_, msg.id_, "• لا يمكنك مطور السورس \n")
return false 
end
if result.id_ == tonumber(1520530041) then
send(msg.chat_id_, msg.id_, "• لا يمكنك مطور السورس \n")
return false 
end
function start_function(extra, result, success)
...
send(msg.chat_id_, msg.id_, "܁♪•┆لايمكنك كتم عيوني  🎸ܰ\n")
return false 
end
if userid == tonumber(1520530041) then
send(msg.chat_id_, msg.id_, "܁♪•┆لايمكنك كتم عيوني  🎸ܰ\n")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
-------------------------------------LOKRAND - @bbbbl - @kgtbm - @VVWVV3 - @K777A ---------------------------------------
...
---------
if text == ("رفع مريض") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁♪•┆تم رفع العضو مريض في المجموعة 😭😹🎸ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
if (text == ("تنزيل مريض")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁♪•┆تم تنزيل العضو مريض في المجموعة 😭😹🎸ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁♪•┆تم رفع العضو وتكه في المجموعة 😭😹🎸ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁♪•┆تم تنزيل العضو وتكه في المجموعة 😭😹🎸ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
-----------------------------------------------------
if text == ("تاك للاعلقاء") and Mod(msg) then
local list = database:smembers(bot_id..'Naby:User'..msg.chat_id_)
t = "\n܁♪•┆يا اعلقاء تعالو يردونكم 😹😭🎸. \n√••••••••••••••••••••••••••••••••••√\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t.."𖠵 "..k.." ◜[@"..username.."]◞\n"
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁♪•┆تم رفع العضو متوحده في المجموعة 😭😹🎸ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁♪•┆تم تنزيل العضو متوحده في المجموعة 😭😹🎸ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁♪•┆تم رفع العضو خول في المجموعة 😭😹🎸ܰ'
local  statuss  = ''
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n܁♪•┆تم تنزيل العضو خول في المجموعة 😭😹🎸ܰ'
status  = ''
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
if text == 'id' and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local Msguser = tonumber(database:get(bot_id..'Msg_User'..msg.chat_id_..':'..result.sender_user_id_) or 1) 
local Contact = tonumber(database:get(bot_id..'Add:Contact'..msg.chat_id_..':'..result.sender_user_id_) or 0) 
...
name = string.gsub(name,'اني','مريض')
...
name = string.gsub(name,'ضراطه','الي يسوق المريض يتحمل___')
name = string.gsub(name,'بيدك','اكل___محد يفيدك')
name = string.gsub(name,'الحافي','تجدي من___نعال')
name = string.gsub(name,'شقره','مع الخيل يا___')
name = string.gsub(name,'النخله','الطول طول___والعقل عقل المتوحدهة')
