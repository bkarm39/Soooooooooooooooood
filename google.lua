...
local inline = {
{{text="- قناة السورس ،",url="t.me/Soooooooooooooooood"},
{text="- جوجل🎸،",url="t.me/KGTBR"}},
{{text="- اضغط هنا لتنصيب السورس ،",url="t.me/KGTBM"}},
{{text="- بار قوقل،",url="https://t.me/kgtgoogle"}},
{text="- شروحات السورس ،",url="t.me/KGTBM"}}
}
send_inline(msg.chat_id_,'✦┋مرحبا بك في سورس هاديه┋Victor ،\n✦┋اضغط على الازرار بالاسفل ⬇️ ،',nil,inline) 
return false 
end
--------------------------------------------------------------------------------------------------------------
...
-------------------------------------LOKRAND - @bbbbl - @KGTBR - @VVWVV3 - @K777A ---------------------------------------
...
√••••••••••••••••••••••••••••••••••√
𖤂┆[CHanneL SourcE](t.me/Soooooooooooooooood) 𖥠 .
]]
