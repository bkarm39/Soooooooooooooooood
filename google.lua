...
{{text="-  𝒄𝒍𝒊𝒄𝒌 𝒉𝒆𝒓𝒆 𝒕𝒐 𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𖡛“   ،",url="t.me/KGTBM"}},
{{text="- : 𝙜𝙧𝙤𝙪𝙗 𝙜𝙤𝙤𝙜𝙚𝙡 ϟ ،",url="https://t.me/kgtgoogle"}},
{{text="- 𝘿𝙀𝙑𝙀𝙇𝙊𝙋𝙀𝙍 ℐᎯℳℳᎯℳ  ،",url="t.me/A_4_P"}}

send_inline(msg.chat_id_,'✦┋  𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝒉𝒂𝒅𝒚 𓁻  ┋Victor ،\n✦┋اضغط على الازرار بالاسفل ⬇️ ،',nil,inline) 
return false 
end
--------------------------------------------------------------------------------------------------------------
